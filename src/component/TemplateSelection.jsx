    ...
    <div style={{ minHeight: "100vh", background: "#f7f8fa", fontFamily: "DM Sans, sans-serif" }}>
      <div style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 60 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <span style={{ fontSize: 13, color: "#fff", background: "#111", padding: "6px 14px", cursor: "pointer", borderRadius: 6, fontWeight: 500 }}>Get started free</span>
        </div>
      </div>

      <div style={{ textAlign: "center", padding: "48px 20px 32px" }}>
        <h1 style={{ fontSize: 36, fontWeight: 700, margin: 0, letterSpacing: -1, fontFamily: "Playfair Display, serif" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px 60px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 20 }}>
          ...
          >
            <div style={{ width: 40, height: 40, borderRadius: "50%", border: "2px solid #111", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, color: "#111" }}>+</div>
